...
foreach ($shippings as $s) {
    if ((int)$s['trang_thai'] === 1) { $activeShipping = $s; break; }
}
...
<head>
    ...
    <style>
        ...
        .ship-main{ flex: 1 1 auto; min-width: 0; }
            ...
            <div class="cardx">
                <div class="cardx-head">
                    <div>
                        ...
                        <div class="mini-muted">Khi chưa có đối tác, hệ thống sẽ hiển thị trạng thái trống.</div>
                    </div>
                </div>
                <div class="cardx-body">
                    <?php if (empty($partners)): ?>
                        <div class="partner-empty">
                            ...
                            <div class="mini-muted mt-1">
                                Khi cần liên kết đối tác mới, bạn có thể thêm 1 bản ghi vào bảng <strong>lienket</strong> với <code>loai='doitac'</code>.
                            </div>
                            <div class="mini-muted mt-2">
                                (Nếu bạn muốn mình làm luôn UI “Thêm đối tác” giống phần vận chuyển thì nói mình.)
                            </div>
                        </div>
                    <?php else: ?>
