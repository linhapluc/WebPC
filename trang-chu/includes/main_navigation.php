...
<header class="site-header">
    <div class="container header-content">
        ...
        <div class="user-actions">
            <?php if (isset($_SESSION['user_id']) && isset($_SESSION['user_name'])): ?>
                <div class="dropdown-container">
                    ...
                    <ul class="dropdown-menu-content" role="menu">
                       <li><a class="dropdown-item" href="lichsu_muahang.php"><i class="fa-solid fa-receipt"></i> Lịch sử mua hàng</a></li>
            ...
            <!-- === BẮT ĐẦU NÚT DARK MODE === -->
            <button id="theme-toggle" class="theme-toggle-btn" title="Chuyển đổi giao diện">
                <i class="fas fa-moon"></i> <!-- Icon mặt trăng mặc định -->
            </button>
            <!-- === KẾT THÚC NÚT DARK MODE === -->
        </div>
    </div>
</header>