            ...
            <div id="hero-carousel" class="carousel slide mb-4" data-bs-ride="carousel">
                ...
                <div class="carousel-inner" style="border-radius: 8px;">
                    ...
                    <div class="carousel-item active">
                        <img src="assets/images/banner1.jpg" class="d-block w-100" alt="Khuyến mãi Build PC">
                    </div>
                    <div class="carousel-item">
                        <img src="assets/images/banner2.jpg" class="d-block w-100" alt="Sản phẩm mới">
                    </div>
                    <div class="carousel-item">
                        <img src="assets/images/banner3.jpg" class="d-block w-100" alt="Chính sách bảo hành">
                    </div>
                </div>
...
<style>
/* ... (PHẦN CODE CSS CÒN LẠI GIỮ NGUYÊN) ... */
.category-sidebar {
    width: 260px;
    flex-shrink: 0;
