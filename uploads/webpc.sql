...
CREATE TABLE `donhang` (
  ...
  `ten_nguoinhan`       VARCHAR(100) NULL DEFAULT NULL,
  `diachi_giaohang`     TEXT         NULL DEFAULT NULL,
  `sdt_nguoinhan`       VARCHAR(20)  NULL DEFAULT NULL,
  `email`               VARCHAR(100) NOT NULL,
  `ghi_chu`             TEXT         NULL DEFAULT NULL,

  `trang_thai`          VARCHAR(50)  NULL DEFAULT 'Pending',

  -- ✅ Chỉ cho phép 2 phương thức: Thanh toán khi nhận hàng / Chuyển khoản
  `phuongthuc_thanhtoan` ENUM('Thanh toán khi nhận hàng','Chuyển khoản') NOT NULL,
...
--
INSERT INTO `donhang` (
  `id_donhang`, `id_khachhang`, `id_sanpham`, `so_luong`,
  `ngay_dat`, `tong_tien`,
  `ten_nguoinhan`, `diachi_giaohang`, `sdt_nguoinhan`,
  `email`, `ghi_chu`,
  `trang_thai`, `phuongthuc_thanhtoan`,
  `xac_nhan_admin`, `otp_code`, `otp_expiry`
)
VALUES
  (
    'DH001', 'KH001', 'SP001', 1,
    '2025-04-23 14:00:00', 1150000,
    'Nguyễn Văn A', '123 Đường A, Quận 1, TP.HCM', '0909123456',
    'a@gmail.com', 'Giao trong giờ hành chính',
    'Đã xác nhận', 'Thanh toán khi nhận hàng',
    0, NULL, NULL
  ),

  (
    'DH002', 'KH002', 'SP006', 1,
    '2025-04-23 15:30:00', 388000,
    'Trần Thị B', '456 Đường B, Quận 3, TP.HCM', '0988123456',
    'b@gmail.com', '',
    'Chờ xử lý', 'Chuyển khoản',
    0, NULL, NULL
  ),

  (
    'DH003', 'KH001', 'SP009', 1,
    '2025-04-24 10:00:00', 1389000,
    'Nguyễn Văn A', '123 Đường A, Quận 1, TP.HCM', '0909123456',
    'a@gmail.com', 'Giao trước 12h trưa',
    'Đã giao hàng', 'Thanh toán khi nhận hàng',
    1, NULL, NULL
  ),

  (
    'DH004', 'KH002', 'SP013', 1,
    '2025-04-24 14:45:00', 4000000,
    'Trần Thị B', '456 Đường B, Quận 3, TP.HCM', '0988123456',
    'b@gmail.com', '',
    'Đã huỷ', 'Chuyển khoản',
    1, NULL, NULL
  ...
  (
    'DH005', 'KH001', 'SP021', 1,
    '2025-04-25 09:00:00', 1195000,
    'Nguyễn Văn A', '123 Đường A, Quận 1, TP.HCM', '0909123456',
    'a@gmail.com', 'Giao sớm giúp mình',
    'Đang vận chuyển', 'Chuyển khoản',
    0, NULL, NULL
  );
...
CREATE TABLE lienket (
    ...
    loai ENUM('vanchuyen', 'doitac') NOT NULL,
...
INSERT INTO lienket (loai, ten_don_vi, dia_chi, ghi_chu)
VALUES (
    'vanchuyen',
    'J&T Express',
    'Kho J&T Express – CN Quận 10, 268 Lý Thường Kiệt, P.14, Q.10, TP.HCM',
    'Giờ nhận hàng: 09:00 – 18:00 (T2–T7). Hotline: 1900 1088'
);
